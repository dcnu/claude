...
if [[ -z "$LAST_README_COMMIT" ]]; then
	# README has never been committed, use initial commit
...
# Significant files: src/, *.ts, *.tsx, *.py, package.json, pyproject.toml, tests/, config files
...
# Threshold: 10+ significant changes
THRESHOLD=10
